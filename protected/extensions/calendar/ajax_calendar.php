...
function getCalendar($month,$year)
{
	...
	<table id="calendar">
	<tr>
		<td><a href="#" class="monthnav" onclick="getPrevMonth();return false;">&laquo; Anterior</a></td>
		<td colspan=5 class="month">$month_name $year</b></td>
		<td><a href="#" class="monthnav" onclick="getNextMonth();return false;">Próximo &raquo;</a></td>
	</tr>
	<tr class="daynames"> 
